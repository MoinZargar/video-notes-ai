  ...
  return (
    <section className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-16 md:py-24">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">{heroData.title}</h1>
        <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto">{heroData.subtitle}</p>
        <Link
